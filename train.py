...
class ABSATrainer:
    ...
    def train(self):
        ...
        print(f"Hoàn thành! Best F1: {best_f1:.4f}. Đã lưu tại: {self.save_dir}/restaurant_best_model.pt\n")
...
def main():
    # Cấu hình cứng
    TRAIN_DATA = "Data/restaurant_train.jsonl"
    VAL_DATA = "Data/restaurant_dev.jsonl"
    BATCH_SIZE = 16
    MAX_LENGTH = 128
    EPOCHS = 15
